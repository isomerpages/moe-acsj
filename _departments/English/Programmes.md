...
<b><u>English Week</u></b><br>
English Week is an annual event eagerly anticipated by students, held yearly with a different theme each time. It's an engaging experience where boys embark on a journey of learning while having fun simultaneously. The week is filled with a series of dynamic activities, all designed to enhance language skills and foster a love for the English Language.
...
To facilitate this, the programme enlists the help of parent volunteers (PVs), typically 4 to 5 for each class. These volunteers generously dedicate their time to participate in one selected EL period per week. Leveraging modern technology, the programme utilizes Zoom, to create an interactive learning environment. Breakout rooms are set up within Zoom, allowing for small group interactions.

During each session, students are assigned to breakout rooms with a PV, where they engage in one-on-one practice sessions to hone their oral communication skills. This personalized approach enables focused attention on each student, allowing them to receive tailored feedback and guidance. With around 9 to 10 students practicing with each PV, the Oracy programme maximizes the opportunity for students to gain valuable speaking experience in a supportive setting.

By leveraging technology and harnessing the dedication of parent volunteers, the Primary 6 Oracy Programme empowers students to develop confidence and proficiency in oral communication, ultimately preparing them for success in the PSLE and beyond.